...
export function generateSortingAnimationArray(
  ...
  switch (selectedAlgorithm) {
    case "bubble":
      generateBubbleSortAnimationArray(isAnimationRunning, array, runAnimation);
      break;
    case "quick":
      generateQuickSortAnimationArray(isAnimationRunning, array, runAnimation);
      break;
    case "merge":
      generateMergeSortAnimationArray(isAnimationRunning, array, runAnimation);
      break;
    case "insertion":
      generateInsertionSortAnimationArray(isAnimationRunning, array, runAnimation);
      break;
    case "selection":
      generateSelectionSortAnimationArray(isAnimationRunning, array, runAnimation);
      break;
    default:
      break;
  };
